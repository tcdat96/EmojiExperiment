 ...
 */
public class EmojiconGridFragmentBackup extends Fragment
        implements AdapterView.OnItemClickListener, EmojisTable.OnItemClickListener {

    private static final String TAG = EmojiconGridFragmentBackup.class.getSimpleName();
    ...
    protected static EmojiconGridFragmentBackup newInstance(Emojicon[] emojicons, EmojiconRecents recents) {
        return newInstance(Emojicon.TYPE_UNDEFINED, emojicons, recents, false);
    }

    protected static EmojiconGridFragmentBackup newInstance(
    ...
    protected static EmojiconGridFragmentBackup newInstance(
        ...
        EmojiconGridFragmentBackup emojiGridFragment = new EmojiconGridFragmentBackup();
