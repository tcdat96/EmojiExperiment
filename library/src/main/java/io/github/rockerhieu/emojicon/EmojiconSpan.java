...
class EmojiconSpan extends DynamicDrawableSpan {
    ...
    private final static String TAG = EmojiconSpan.class.getSimpleName();
    ...
    private static SparseArray<Drawable> mCaches = new SparseArray<>();
...
//        if (mDrawableRef == null || mDrawableRef.get() == null) {
//            mDrawable = mCaches.get(mResourceId);
//            if (mDrawable == null) {
//                mDrawableRef = new WeakReference<>(getDrawable());
//                mCaches.put(mResourceId, mDrawable);
//            } else {
