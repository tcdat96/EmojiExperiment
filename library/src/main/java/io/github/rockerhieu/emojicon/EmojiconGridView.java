...
public class EmojiconGridView extends GridView implements AdapterView.OnItemClickListener {
    ...
    private EmojiconGridFragmentUsingLitho.OnEmojiconClickedListener onEmojiconClickedListener;
    private GridAdapter mEmojiAdapter;
    ...
    public EmojiconGridView(Context context, AttributeSet attrs) {
        ...
        mEmojiAdapter = new GridAdapter(context, mEmojiList);
    ...
    public void setOnEmojiconClickedListener(EmojiconGridFragmentUsingLitho.OnEmojiconClickedListener onEmojiconClickedListener) {
